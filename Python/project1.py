...
def randtotal(dayno,totalitems):
    ...
    for x in range(0,7):
        while T:
            ...
            if number in nolist:
                nolist.remove(number)
                break
        newtotal.append(totalitems[number])
    return newtotal
Total1_breakfast =randtotal(day_number,Total1_breakfast)
Total2_breakfast =randtotal(day2_number,Total2_breakfast)    
Total3_breakfast =randtotal(day3_number,Total3_breakfast)
Total4_breakfast =randtotal(day4_number,Total4_breakfast)
Total1_Dinner =randtotal(day_number,Total1_Dinner)
Total2_Dinner =randtotal(day2_number,Total2_Dinner)
Total3_Dinner =randtotal(day3_number,Total3_Dinner)
Total4_Dinner =randtotal(day4_number,Total4_Dinner)
Total1_Lunch = randtotal(day_number,Total1_Lunch)
Total2_Lunch = randtotal(day2_number,Total2_Lunch)
Total3_Lunch = randtotal(day3_number,Total3_Lunch)
Total4_Lunch = randtotal(day4_number,Total4_Lunch)
Total1_snack1 = randtotal(day_number,Total1_snack1)
Total2_snack1 = randtotal(day2_number,Total2_snack1)
Total3_snack1 = randtotal(day3_number,Total3_snack1)
Total4_snack1 = randtotal(day4_number,Total4_snack1)
Total1_snack2 = randtotal(day_number,Total1_snack2)
Total2_snack2 = randtotal(day2_number,Total2_snack2)
Total3_snack2 = randtotal(day3_number,Total3_snack2)
Total4_snack2 = randtotal(day4_number,Total4_snack2)
